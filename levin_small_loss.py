...
from networks.cnn import pair_downsampler
import cv2
import torch
import torch.optim
import glob
...
parser.add_argument('--save_path', type=str, default="results/levin_original_loss/", help='path to save results')
...
def draw_loss(loss,step):
    ...
    plt.grid(True)
    plt.savefig('levin_original_loss.png',dpi=600)
